...
const driverLocation = {
    latitude: 12.9715987, // Dummy latitude
    longitude: 77.5945627 // Dummy longitude
};

const driverName = "John Doe"; // Dummy driver name
...
export default function RideScreen() {
    ...
    // UseEffect to request location permission on component mount
    useEffect(() => {
